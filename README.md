...
# 上游规则引用说明
本项目的广告拦截、隐私防护、内容净化能力，均基于社区优秀的开源过滤规则开发，以下是项目所采用的全部上游规则源，感谢所有规则维护者的开源贡献！

## 国内常用规则
### 乘风广告过滤规则
```
https://github.com/xinggsf/Adblock-Plus-Rule/raw/refs/heads/master/rule.txt
```
### 乘风视频广告过滤
```
https://github.com/xinggsf/Adblock-Plus-Rule/raw/refs/heads/master/mv.txt
```
### 乘风小众视频广告过滤
```
https://github.com/xinggsf/Adblock-Plus-Rule/raw/refs/heads/master/minority-mv.txt
```
### 大圣净化内置列表（国内视频适配）
```
...
```
### AdGuardHome 国际规则(all)
```
https://raw.githubusercontent.com/BlueSkyXN/AdGuardHomeRules/master/all.txt
```
### AdGuardHome 国际规则(sky)
```
...
### 简化域名过滤规则
```
https://github.com/AdguardTeam/AdGuardSDNSFilter/raw/gh-pages/Filters/rules.txt
```
### AdGuard DNS 核心过滤
```
...
```
### StevenBlack 综合 Hosts
```
https://raw.githubusercontent.com/StevenBlack/hosts/master/hosts
```
### Dan Pollock 经典 Hosts
```
...
filters:
  ...
  - enabled: false
    ...
    name: 钓鱼网站拦截(PhishTank/OpenPhish)
    id: 100050
  - enabled: false
